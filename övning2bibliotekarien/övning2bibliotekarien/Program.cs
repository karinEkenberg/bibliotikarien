...
namespace övning2bibliotekarien
{
    static class Bibliotekarien                                                                           // skapar en klass

    {
        ...
        public Bibliotekarien(string titel, string författare, string typ, int utgivningsår)       // bokens konstruktor
        {
...

        {
            ...
            return Titel + ", " + Författare + ", " + Typ + " gavs ut år " + Utgivningsår;
    ...
    class Roman : Bibliotekarien                                                                  // tre underklasser till bok klassen
    ...
    class Tidskrift : Bibliotekarien
    ...
    class Novellsamling : Bibliotekarien
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            List<Bibliotekarien> mittBibliotek = new List<Bibliotekarien>();                                // skapar en lista för menyn
...

            {
                ...
                Console.WriteLine("[4] - Sök bland böcker.");
...

                {
                    ...
                    case 2:                                                     // om användaren gör menyval 2
...

                        {
                            ...
                            foreach (Bibliotekarien item in mittBibliotek)                 // för varje bok i vår lista med böcker
